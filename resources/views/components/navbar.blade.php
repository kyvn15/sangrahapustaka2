        ...
        <div class="container mx-auto flex flex-wrap items-center justify-between px-4 py-3">
            ...
            <div class="ml-2 flex space-x-2">
                <a href="{{ route('login.index') }}"
                    class="bg-blue-100 text-blue-600 px-4 py-2 rounded-full hover:bg-blue-200 font-semibold">Masuk</a>
                <a href="{{ route('signup.index') }}"
                    class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 font-semibold">Daftar</a>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Biar klik di dalam dropdown gak nutup menu
